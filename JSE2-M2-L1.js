...
Try to prepare a simple system to store information about students and teachers and combine
them for tutoring.

Create a 'User' class to create objects for both teachers and students. The constructor should
take the user data (name, surname, email, role), but be sure to create the appropriate
properties. 
...
- 'addCourse(course, level)' - which will allow you to add course (e.g. math) and level 
  ...
  mean that they are looking for help on this level, and in case of a teacher, it will mean
  that they can help up to this level;
- 'removeCourse(course)' - which will allow you to remove the course (e.g. if the student
   is no longer interested in learning math)
...
- showMessagesHistory() - which will display the history of all messages sent to the user
  in the console.
 */
